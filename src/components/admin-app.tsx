...
import { LoaderCircle, Plus, UserRoundCheck, UserRoundX } from 'lucide-react'
...
export function AdminApp({ section }: { section: 'accounts' | 'audit' | 'domains' | 'mailboxes' | 'aliases' | 'access' | 'routing' }) {

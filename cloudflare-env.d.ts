/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: f3137fee435003757d41643db5704bce)
...
interface __BaseEnv_CloudflareEnv {
	...
	AI_SPAM_RATE_LIMIT: RateLimit;
	AI_JUDGMENT_RATE_LIMIT: RateLimit;
	AI: Ai;
	REALTIME: DurableObjectNamespace<import("./src/server").RealtimeHub>;
	WORKER_SELF_REFERENCE: Service<typeof import("./src/server").default>;
	DATABASE_BACKUP_WORKFLOW: Workflow<Parameters<import("./src/server").DatabaseBackupWorkflow['run']>[0]['payload']>;
}
